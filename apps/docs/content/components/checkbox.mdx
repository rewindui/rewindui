...
# Tones & Colors
---
The Button component comes with four tones: `solid` and `light`. The only difference between the two tones is the unchecked state. The `solid` tone has a white background and the `light` tone has a light gray background.
