...
<View>
  <DropdownShowcase showcase="initially-open" />
</View>
...
<View>
  <DropdownShowcase showcase="outside-press" />
</View>
...
| itemColor       | `DropdownItemColor` | Sets the dropdown items color                                                                                                                              | `blue`   |
...
| Prop     | Type                | Description                               | Default |
|:---------|:--------------------|:------------------------------------------|:--------|
| color    | `DropdownItemColor` | Sets the dropdown item color              | `blue`  |
