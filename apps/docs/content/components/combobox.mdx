...
# Colors
---
Using the `color` prop, the color of the selected option can be adjusted.
...
| color         | `ComboboxColor`      | Sets the selected option color                     | `purple`    |
...
| Prop    | Type                  | Description                        | Default     |
|:--------|:----------------------|:-----------------------------------|:------------|
| color   | `ComboboxColor`       | Sets the group heading color       | `gray`      |
