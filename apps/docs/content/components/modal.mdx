...
# Colors
---
The `Modal` component comes with four colors: `white`, `gray`, `zinc` and `slate`.

<View>
  <ModalShowcase showcase="colors" />
</View>
...
# Overlay
---
The underlying Overlay component can be customized using the `overlayColor`, `overlayBlur` and `overlayOpacity` props. For more information on the Overlay component, see the [Overlay](https://rewind-ui.dev/components/overlay) component documentation.
