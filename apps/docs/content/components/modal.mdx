...
```tsx
import { Modal } from '@idb-dab/ui-core';
```
...
import { Modal, Card, Button } from '@idb-dab/ui-core';
...
```tsx
import { Button, Card, Modal, Text } from '@idb-dab/ui-core';
import { useState } from 'react';
...
```tsx
import { Button, Card, Modal } from '@idb-dab/ui-core';
import { useState } from 'react';
import * as React from 'react';
import { X } from '@phosphor-icons/react';
