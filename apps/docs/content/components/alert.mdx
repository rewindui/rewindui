...
<View>
  <Alert shadow="lg" color="blue" shadowColor="blue">Alert</Alert>
  <Alert shadow="lg" color="red" shadowColor="red">Alert</Alert>
  <Alert shadow="lg" color="green" shadowColor="green">Alert</Alert>
  <Alert shadow="lg" color="yellow" shadowColor="yellow">Alert</Alert>
  <Alert shadow="lg" color="purple" shadowColor="purple">Alert</Alert>
  <Alert shadow="lg" color="gray" shadowColor="gray">Alert</Alert>
  <Alert shadow="lg" color="dark" shadowColor="dark">Alert</Alert>
  <Alert shadow="lg" color="black" shadowColor="black">Alert</Alert>
</View>
...
| color                | `AlertColor`       | Sets the color                                      | `blue`      |
...
| variant              | `AlertVariants`    | Sets the alert variant                              | `true`      |
