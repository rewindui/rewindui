...
|:------------|:--------------------|:-----------------------|:------------|
| color       | `RibbonColor`       | Sets the color         | `purple`    |
...
| size        | `RibbonSize`        | Sets the badge size    | `md`        |
| tone        | `RibbonTone`        | Sets the badge tone    | `solid`     |
| variant     | `RibbonVariant`     | Sets the badge variant | `undefined` |
