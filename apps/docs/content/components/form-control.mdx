...
<View>
  <FormControl>
    ...
    <FormControlText className="text-gray-400">* Password must be minimum 8 characters long</FormControlText>
  </FormControl>
</View>
...
<View>
  <FormControl>
    ...
    <FormControl.Text className="text-gray-400">* Password must be minimum 8 characters long</FormControl.Text>
  </FormControl>
</View>
```
